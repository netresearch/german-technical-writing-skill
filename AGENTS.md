...
Natural German technical register for Jira, MR descriptions, commit messages, and team-facing artifacts.
...
Skill fires for German prose longer than one sentence in persistent or team-facing artifacts: Jira comments and descriptions, MR/PR titles and descriptions, commit messages, release notes, RFC/spec documents, team-channel messages.

Skill does **not** fire for: conversational German chat replies, internal reasoning, single-word acknowledgements, English artifacts that merely contain German identifiers.
